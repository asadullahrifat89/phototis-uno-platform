import { config } from "./package_09276acd98a727c239fe3e0be442561b181d8f6d//uno-config.js";
...
self.addEventListener('install', function (e) {
    ...
    e.waitUntil(
        caches.open('package_09276acd98a727c239fe3e0be442561b181d8f6d').then(async function (cache) {
